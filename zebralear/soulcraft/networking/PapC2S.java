...
public class PapC2S {
 ...
 public PapC2S(FriendlyByteBuf buf) {
	 }
	 ...
	 context.enqueueWork(() -> {
		 ...
		 player.getCapability(SoulHasProvider.Soul_Has).ifPresent(soulHas -> {
			 ...
			 if(SoulCheck != 1) {
				 soulHas.addSoul(1);
				 soulType.setType(6);
				 Minecraft.getInstance().player.sendSystemMessage(Component.literal("You feel a yearning to become something more. Perhaps this will ready you for combat"));
			 } else {
